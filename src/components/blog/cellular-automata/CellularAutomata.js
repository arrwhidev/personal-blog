...
const SCRIPT_SRC = "https://cdn.jsdelivr.net/gh/arrwhidev/cellular-automata@ec6c569b70f4e83e008c56535ab64a9a98d0bcaa/wolfram.js"
    ...
    render() {
        ...
        return (
            <div className="application">
                ...
                />
                <canvas id='canvas' width='800' height='320' style={{width: '100%'}} />
            </div>)
        ;
    }
}